#3 Special version cscDigiDump_cfg.py to look for 'mix' digi collections
## 04.02.2014
...
##    fileNames = cms.untracked.vstring("file:/afs/cern.ch/work/p/ptc/public/DATA/r700pre11simupt100.root")
      fileNames = cms.untracked.vstring("file:csc_digis_25.root")
)

process.load("cscMixDigiDump_cfi")
